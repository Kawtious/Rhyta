...
[issues-shield]: https://img.shields.io/github/issues/Kawtious/Rhyta.svg?style=for-the-badge
[issues-url]: https://github.com/Kawtious/Rhyta/issues
[license-shield]: https://img.shields.io/github/license/Kawtious/Rhyta.svg?style=for-the-badge
[license-url]: https://github.com/Kawtious/Rhyta/blob/master/LICENSE
...
1. Clone the repository to your local machine:
    ...
    ```bash
    git clone https://github.com/Kawtious/Rhyta.git
    ```
...
4. Configure the Databases:
    ...
    ```plaintext
    DATABASE_HOST="your_mysql_host"             # "localhost"
    DATABASE_PORT=your_mysql_port               # 3306
    DATABASE_USER="your_mysql_user"             # "user"
    DATABASE_PASSWORD="your_mysql_password"     # "password"
    DATABASE_NAME="your_mysql_database_name"    # "mydb"
    ```
